...
```
    ...
    ##   `C:\Users\Administrator.KJLWS11\Documents\Lab2\Data\elc_habitat.shp' 
...
```
    ...
    ##   `C:\Users\Administrator.KJLWS11\Documents\Lab2\Data\humanacess.shp' 
    ##   using driver `ESRI Shapefile'
...
```
    ...
    ##   `C:\Users\Administrator.KJLWS11\Documents\Lab2\Data\wolfyht.shp' 
    ##   using driver `ESRI Shapefile'
...
remind ourselves of the structure of the sf object wolfyht.
...
For today’s lab we will us elevation and distance to human access
...
![](README_files/figure-gfm/unnamed-chunk-15-1.png)<!-- --> Now you
would go through and rasterize this following the steps above to make
this a raster file. Note I already did this with the distance to high
human access layer.
...
```
    ...
    ## 1  1      4       5     5       3      3      5   1762.432             268.6442
    ## 2  2      4       5     5       3      1      5   1791.456             305.4668
    ## 3  3      4       5     5       4      1      5   1770.521             331.2791
    ## 4  4      4       5     5       4      1      5   1737.813             220.0098
    ## 5  5     NA      NA    NA      NA     NA     NA   2017.875             140.6329
    ## 6  6      1       1     1       1      4      1   1897.946             746.3893
...
```
    ...
    ##  $ DEER_W                  : num  4 4 4 4 4 5 4 5 4 NA ...
    ##  $ MOOSE_W                 : num  5 6 4 5 5 3 5 5 5 NA ...
    ##  $ ELK_W                   : num  5 5 5 5 5 5 5 5 4 NA ...
    ##  $ SHEEP_W                 : num  3 1 3 3 4 1 4 3 3 NA ...
    ##  $ GOAT_W                  : num  3 1 1 1 1 1 1 1 1 NA ...
    ##  $ WOLF_W                  : num  5 5 5 5 5 5 5 5 4 NA ...
    ##  $ Elevation2              : num  1762 1403 1514 1791 1771 ...
    ##  $ DistFromHumanAccess2    : num  269 227 549 305 331 ...
    ##  $ DistFromHighHumanAccess2: num  9294 243 336 10367 10384 ...
    ##  $ pack                    : chr  "Red Deer" "Bow Valley" "Bow Valley" "Red Deer" ...
...
```
    ...
    ##   ID DEER_W MOOSE_W ELK_W SHEEP_W GOAT_W WOLF_W Elevation2 DistFromHumanAccess2
    ## 1  1      4       5     5       3      3      5   1762.432             268.6442
    ## 2  1      4       6     5       1      1      5   1402.741             227.3770
    ## 3  2      4       4     5       3      1      5   1513.968             548.6088
    ## 4  2      4       5     5       3      1      5   1791.456             305.4668
    ## 5  3      4       5     5       4      1      5   1770.521             331.2791
    ## 6  3      5       3     5       1      1      5   1404.123             172.9716
    ##   DistFromHighHumanAccess2       pack
    ## 1                9294.3262   Red Deer
    ## 2                 242.5136 Bow Valley
    ## 3                 336.2133 Bow Valley
    ## 4               10367.2598   Red Deer
    ## 5               10384.2539   Red Deer
    ## 6                 216.4412 Bow Valley
...
```
    ...
    ##        ID            DEER_W         MOOSE_W         ELK_W         SHEEP_W    
    ##  Min.   :  1.0   Min.   :1.000   Min.   :1.00   Min.   :1.00   Min.   :1.00  
    ##  1st Qu.: 52.0   1st Qu.:4.000   1st Qu.:3.00   1st Qu.:4.00   1st Qu.:1.00  
    ##  Median :114.0   Median :5.000   Median :4.00   Median :5.00   Median :3.00  
    ##  Mean   :134.9   Mean   :4.652   Mean   :4.07   Mean   :4.63   Mean   :2.69  
    ##  3rd Qu.:217.0   3rd Qu.:5.000   3rd Qu.:5.00   3rd Qu.:5.00   3rd Qu.:4.00  
    ##  Max.   :320.0   Max.   :7.000   Max.   :7.00   Max.   :7.00   Max.   :7.00  
    ##                  NA's   :13      NA's   :13     NA's   :13     NA's   :13    
    ##      GOAT_W          WOLF_W        Elevation2   DistFromHumanAccess2
    ##  Min.   :1.000   Min.   :1.000   Min.   :1402   Min.   :  39.74     
    ##  1st Qu.:1.000   1st Qu.:4.000   1st Qu.:1412   1st Qu.: 139.37     
    ##  Median :1.000   Median :5.000   Median :1444   Median : 206.35     
    ##  Mean   :1.748   Mean   :4.772   Mean   :1551   Mean   : 321.18     
    ##  3rd Qu.:3.000   3rd Qu.:5.000   3rd Qu.:1606   3rd Qu.: 397.26     
    ##  Max.   :7.000   Max.   :7.000   Max.   :2255   Max.   :2453.63     
    ##  NA's   :13      NA's   :13                     NA's   :4           
    ##  DistFromHighHumanAccess2     pack                used  
    ##  Min.   :    0.218        Length:413         Min.   :1  
    ##  1st Qu.:  109.084        Class :character   1st Qu.:1  
    ##  Median :  215.447        Mode  :character   Median :1  
    ##  Mean   : 1212.772                           Mean   :1  
    ##  3rd Qu.:  435.780                           3rd Qu.:1  
    ##  Max.   :11472.898                           Max.   :1  
    ##  NA's   :4
...
```
    ...
    ##  Median :118.50   Median :5.000   Median :4.000   Median :5.000  
    ##  Mean   :136.69   Mean   :4.659   Mean   :4.063   Mean   :4.634  
    ...
    ##  1st Qu.:1.000   1st Qu.:1.000   1st Qu.:4.000   1st Qu.:1410  
    ##  Median :3.000   Median :1.000   Median :5.000   Median :1441  
    ##  Mean   :2.692   Mean   :1.745   Mean   :4.773   Mean   :1538  
    ##  3rd Qu.:4.000   3rd Qu.:3.000   3rd Qu.:5.000   3rd Qu.:1572  
    ##  Max.   :7.000   Max.   :7.000   Max.   :7.000   Max.   :2255  
    ##  DistFromHumanAccess2 DistFromHighHumanAccess2     pack                used  
    ##  Min.   :  39.74      Min.   :    0.218        Length:396         Min.   :1  
    ##  1st Qu.: 139.37      1st Qu.:  108.853        Class :character   1st Qu.:1  
    ##  Median : 210.36      Median :  211.572        Mode  :character   Median :1  
    ##  Mean   : 315.07      Mean   : 1090.483                           Mean   :1  
    ##  3rd Qu.: 398.79      3rd Qu.:  407.933                           3rd Qu.:1  
    ##  Max.   :2226.34      Max.   :11472.898                           Max.   :1
...
```
    ...
    ## 1 Bow Valley 4.911392 4.756329 4.018987 2.531646 1.560127
    ## 2   Red Deer 3.662500 4.150000 4.237500 3.325000 2.475000
